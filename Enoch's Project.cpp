...
int main()
{
    ...
    newCourse[0].setCourse("Mechanics","MATH124 ");
    newCourse[1].setCourse("Introduction_To_Computer_Science_II", "CSCD102");
    newCourse[2].setCourse("Introduction_To_Statistics","STAT111");
    newCourse[3].setCourse("Information_Systems","CSCD201");
    newCourse[4].setCourse("Vectors_And_Geometry","MATH123");

    Staff newStaff[10];
    newStaff[0].setStaff("Dr. Peter Acquah","10001");
    newStaff[1].setStaff("Mr.Solomon Boateng","10002");
    newStaff[2].setStaff("Dr. Larry Asiedu","10003");
    newStaff[3].setStaff("Mr Ecklu","10004");
    newStaff[4].setStaff("Dr. Sheba","10005");
